...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/03/06 15:31:47 by mathonon          #+#    #+#             */
/*   Updated: 2023/03/06 15:44:07 by mathonon         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_isometric(int n_node, t_fdf *fdf)
{
	...
	if (z > 0)
		z += fdf->move.z;
	fdf->pos->x = x * cos(rad(fdf->grid.angle.x)) + y
		*cos(rad(fdf->grid.angle.x + 120)) + z
		*cos(rad(fdf->grid.angle.x - 120));
	fdf->pos->y = x * sin(rad(fdf->grid.angle.y)) + y
		* sin(rad(fdf->grid.angle.y + 120)) + z
		* sin(rad(fdf->grid.angle.y - 120));
